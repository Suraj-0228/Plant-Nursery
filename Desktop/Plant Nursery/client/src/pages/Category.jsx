        ...
        <aside className="w-full md:w-1/4">
          <div className="p-4 bg-base-200 rounded-lg shadow-lg">
            ...
            <div className="collapse collapse-arrow bg-base-100">
              ...
              <div className="collapse-content">
                <select className="select select-bordered w-full max-w-xs" onChange={(e) => setSort(e.target.value)} value={sort}>
                ...
                <div key={plant._id} className="card bg-base-100 shadow-xl rounded-lg overflow-hidden group transform transition duration-500 hover:scale-105">
                  ...
                  <div className="p-4 bg-base-200">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="badge badge-outline">{plant.careDifficulty}</div>
                    </div>
